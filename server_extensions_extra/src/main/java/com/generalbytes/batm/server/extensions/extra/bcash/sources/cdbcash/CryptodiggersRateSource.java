 ...
 *
 ************************************************************************************/
package com.generalbytes.batm.server.extensions.extra.bcash.sources.cdbcash;

import com.generalbytes.batm.server.extensions.Currencies;
import com.generalbytes.batm.server.extensions.extra.bcash.sources.cdbcash.*;
import com.generalbytes.batm.server.extensions.Currencies;
...
public class CryptodiggersRateSource implements IRateSource{
    ...
    public BigDecimal getExchangeRateLast(String cryptoCurrency, String fiatCurrency) {
        if (!(Currencies.BTC.equalsIgnoreCase(cryptoCurrency) || Currencies.BCASH.equalsIgnoreCase(cryptoCurrency))) {
            return null;
        }
